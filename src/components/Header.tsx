      ...
      <div className="flex w-full max-w-[1200px] items-center justify-between py-5 mx-5">
        <div className="flex items-center gap-5">
          <NavLink to="/" className="flex items-center">
            <img
              src={logo}
              alt="Civil Claim Lawyer"
              title="Civil Claim Lawyer"
              className="w-12 h-auto mr-4 toleft"
            />
            <span className="mr-1 text-2xl font-bold -translate-y-1/2 text-color1 whitespace-nowrap">
              Civil Claim
            </span>
            <span className="ml-1 text-2xl font-bold text-color1 translate-y-1/2 -translate-x-[60px]">
              Lawyer
            </span>
          </NavLink>
        </div>
