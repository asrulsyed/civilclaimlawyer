    ...
    return(
        <>
            <div className="w-full py-[100px] flex flex-col items-center bg-color2 text-center">
                ...
                <h1 className="pt-5 text-5xl font-bold text-color3">What is your legal issue?</h1>
                ...
                <div className="mt-[100px] grid lg:grid-cols-4 sm:grid-cols-2">
                    {
                        legalCategories.map((item, index) => {
                            return <MostCommonCard item={item} key={index} />
                        })
                    }
                </div>
            </div>
