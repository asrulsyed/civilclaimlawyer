                    ...
                    >
                        ...
                        <div className="flex flex-col justify-between w-full">
                            ...
                            <Form.Item name={['medical']}
                                label={<p className="font-bold text-[white] text-xl">Did the incident cause hospitalization or medical treatment ?</p>}
                                rules={[{ required: true }]}
                            // style={{ width: '48%' }}
                            >
                                <select className="w-full h-[40px] outline-none rounded-[5px] text-base pl-2">
                        ...
                        <div className="flex flex-col justify-between w-full">
                            ...
                            >
                                <select className="w-full h-[40px] outline-none rounded-[5px] text-base pl-2">
                                    <option value="Back or Neck Pain">Personal Injury</option>
                                    <option value="Headaches">Loss of Opportunity</option>
                                    <option value="Cuts and Bruises">Financial Loss</option>
                                    <option value="Broken Bones">Wrongful Conviction </option>
                                </select>
                            </Form.Item>
                        </div>
